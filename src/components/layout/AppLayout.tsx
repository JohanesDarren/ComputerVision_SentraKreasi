      ...
      <div className="relative z-10 flex h-full w-full p-4 md:p-6 gap-6">
        <aside className="hidden md:flex flex-col w-[80px] py-8 items-center border-[4px] border-[#2C2825] dark:border-[#EFEBE1] rounded-none bg-[#EFEBE1] dark:bg-[#1E1C1A] h-full justify-between shrink-0 transition-colors duration-500">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      ...
                      isActive 
                        ? "bg-[#386641] text-white border-[#2C2825] dark:border-[#EFEBE1]" 
          ...
          <div className="flex flex-col gap-6 items-center">
            ...
            <div className="w-12 h-12 flex items-center justify-center border-[3px] border-[#2C2825] dark:border-[#EFEBE1] bg-[#FAF8F5] dark:bg-[#151413] transition-colors cursor-pointer hover:bg-[#EFEBE1] dark:hover:bg-[#1E1C1A]">
              <User className="w-6 h-6 text-[#2C2825] dark:text-[#EFEBE1] stroke-[2.5px]"/>
            </div>
            <button 
              onClick={() => navigate('/login')}
              className="w-12 h-12 flex items-center justify-center bg-[#E36D4F] text-white border-[3px] border-[#2C2825] dark:border-[#EFEBE1] hover:opacity-90 transition-colors"
              title="Keluar"
            >
        ...
        <main className="flex-1 flex flex-col h-full overflow-hidden relative">
           <header className="md:hidden flex items-center justify-between p-4 bg-[#EFEBE1] dark:bg-[#1E1C1A] border-[4px] border-[#2C2825] dark:border-[#EFEBE1] mb-6 z-20 transition-colors">
             ...
             <div className="flex items-center gap-3">
               <ThemeToggle />
               <button onClick={() => navigate('/login')} className="w-10 h-10 flex items-center justify-center bg-[#E36D4F] text-white border-[3px] border-[#2C2825] dark:border-[#EFEBE1] hover:opacity-90">
