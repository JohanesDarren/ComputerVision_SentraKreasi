 ...
 return (
  <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 h-full p-4 md:p-8 text-slate-900 dark:text-white relative">
   ...
   <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div className="bg-slate-100 dark:bg-slate-800 shadow-sm border border-slate-300 dark:border-slate-700 rounded-3xl p-6 flex flex-col">
     ...
     <div className="flex-1 space-y-4">
       {isLoading ? (
        ...
        <div key={item.id} className="flex items-center justify-between p-4 bg-slate-100 dark:bg-slate-800 shadow-sm border border-slate-300 dark:border-slate-700 rounded-2xl">
    ...
    <div className="bg-slate-100 dark:bg-slate-800 shadow-sm border border-slate-300 dark:border-slate-700 rounded-3xl p-6 flex flex-col justify-center items-center text-center relative overflow-hidden group">
      ...
      <button className="mt-8 px-8 py-3 bg-slate-200 dark:bg-slate-700 shadow-sm dark:shadow-none hover:bg-white dark:hover:bg-white/20 border border-slate-300 dark:border-slate-700 rounded-full text-sm font-semibold transition-all ">
       Cek Log Sistem
      </button>
    </div>
   </div>
