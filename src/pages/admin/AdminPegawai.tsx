...
export default function AdminPegawai() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 h-full p-4 md:p-8 text-slate-900 dark:text-white relative">
      ...
      <div className="bg-white/95 dark:bg-white/5 shadow-xl dark:shadow-none border border-slate-900/10 dark:border-white/10 rounded-3xl overflow-hidden flex flex-col transition-colors backdrop-blur-xl">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="border-b border-slate-900/10 dark:border-white/10 bg-black/20">
                ...
                <tr key={item.id} className="hover:bg-white/95 dark:bg-white/5 shadow-xl dark:shadow-none transition-colors group">
                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center justify-end gap-2">
                       <button className="p-2 rounded-xl bg-white/95 dark:bg-white/5 shadow-xl dark:shadow-none hover:bg-white/90 dark:bg-white/10 shadow-xl dark:shadow-none text-slate-700 dark:text-white/70 hover:text-slate-900 dark:text-white transition-all border border-white/5">
