...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#e0f2fe] via-[#f0fdf4] to-[#ffffff] dark:from-[#020617] dark:via-[#022c22] dark:to-[#000000] text-slate-800 dark:text-white font-sans overflow-x-hidden selection:bg-emerald-500 selection:text-white transition-colors duration-500">
      ...
      {/* Navbar */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 border-b border-slate-900/5 dark:border-white/5 ${scrolled ? 'bg-white/80 dark:bg-[#021811]/80 backdrop-blur-xl py-4 shadow-lg' : 'bg-transparent py-5'}`}>
        <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden sm:flex p-1 bg-white/50 dark:bg-white/5 rounded-full border border-slate-200 dark:border-white/10 backdrop-blur-md">
              <ThemeToggle />
            </div>
            <button 
              onClick={() => navigate('/login')}
              className="bg-white/90 dark:bg-white/5 shadow-md dark:shadow-none border border-slate-200 dark:border-white/10 hover:bg-white dark:hover:bg-white/10 text-slate-800 dark:text-white px-6 py-2 rounded-full text-sm font-semibold transition-all backdrop-blur-md">
              Login
            </button>
            <button 
      ...
      <main className="relative z-10 pt-32 lg:pt-48 pb-20 max-w-[1200px] mx-auto px-6">
        ...
        <section id="hero" className="relative mb-32 pb-20 flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-sm font-bold mb-8 shadow-sm backdrop-blur-sm">
        ...
        <section id="fitur" className="py-20 mb-20 relative">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white/80 dark:bg-white/5 shadow-xl dark:shadow-none border border-slate-200/60 dark:border-white/10 p-8 rounded-3xl backdrop-blur-xl hover:bg-white dark:hover:bg-white/10 transition-all group">
              ...
              <div className="bg-gradient-to-b from-blue-50/80 to-white/80 dark:from-emerald-500/10 dark:to-transparent border border-blue-200 dark:border-emerald-500/20 p-8 rounded-3xl backdrop-blur-xl hover:border-blue-300 dark:hover:border-emerald-500/40 shadow-xl dark:shadow-none transition-all group relative overflow-hidden">
        ...
        <section className="py-20 mb-20 relative" id="akses">
          <div className="bg-white/90 dark:bg-white/5 shadow-2xl dark:shadow-none border border-slate-200/60 dark:border-white/10 rounded-[3rem] p-8 md:p-16 backdrop-blur-xl relative overflow-hidden">
        ...
        <footer className="pt-20 border-t border-slate-200 dark:border-white/10" id="hubungi">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
             <a href="https://instagram.com/sentrakreasi.ukm" target="_blank" rel="noopener noreferrer" className="bg-white/80 dark:bg-white/5 shadow-md dark:shadow-none border border-slate-200/60 dark:border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center hover:bg-white dark:hover:bg-white/10 transition-all group backdrop-blur-md">
             ...
             <a href="https://maps.google.com/?q=Sentrakreasi+Bandung+-7.0145892,107.595449" target="_blank" rel="noopener noreferrer" className="bg-white/80 dark:bg-white/5 shadow-md dark:shadow-none border border-slate-200/60 dark:border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center hover:bg-white dark:hover:bg-white/10 transition-all group backdrop-blur-md">
             ...
             <a href="tel:+6289611284382" className="bg-white/80 dark:bg-white/5 shadow-md dark:shadow-none border border-slate-200/60 dark:border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center hover:bg-white dark:hover:bg-white/10 transition-all group backdrop-blur-md">
             ...
             <a href="mailto:sentrakreasibandung@gmail.com" className="bg-white/80 dark:bg-white/5 shadow-md dark:shadow-none border border-slate-200/60 dark:border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center hover:bg-white dark:hover:bg-white/10 transition-all group backdrop-blur-md">
        ...
        <div className="fixed bottom-8 right-8 z-50 flex items-center gap-4 group">
           <div className="bg-white dark:bg-white/10 shadow-lg dark:shadow-none backdrop-blur-xl border border-slate-200 dark:border-white/10 text-slate-800 dark:text-white text-xs font-bold px-4 py-2 rounded-full opacity-0 translate-x-4 pointer-events-none group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
             Chat dengan Admin
           </div>
