    ...
    <div className="relative min-h-screen bg-gradient-to-br from-[#e0f2fe] via-[#f0fdf4] to-[#ffffff] dark:from-[#020617] dark:via-[#022c22] dark:to-[#000000] text-slate-800 dark:text-white font-sans overflow-x-hidden selection:bg-emerald-500 selection:text-white p-4 md:p-8">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between mb-8">
          <button onClick={() => navigate('/')} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:bg-white dark:hover:bg-white/10 text-sm font-semibold transition-all backdrop-blur-md shadow-sm dark:shadow-none text-slate-800 dark:text-white">
        ...
        <div className="relative overflow-hidden bg-black border border-slate-900/10 dark:border-white/10 rounded-[2.5rem] aspect-[4/3] md:aspect-[16/9] isolate flex items-center justify-center shadow-2xl">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative w-56 h-56 md:w-72 md:h-72 border-2 border-emerald-500/50 rounded-3xl bg-emerald-500/5 flex flex-col justify-between p-2 shadow-[inset_0_0_50px_rgba(16,185,129,0.1)]">
                ...
                {!isScanning && !scanResult && (
                   <div className="self-center flex items-center gap-2 bg-white/80 dark:bg-black/50 backdrop-blur-md px-4 py-2 text-xs font-semibold text-emerald-600 dark:text-emerald-400 rounded-full border border-emerald-200 dark:border-emerald-500/30">
          ...
          <div className="absolute bottom-6 inset-x-0 z-30 flex justify-center">
            <button
              ...
              className={cn(
                "flex items-center justify-center gap-3 px-8 py-4 rounded-full font-bold transition-all backdrop-blur-md",
                isScanning 
                  ? "bg-white/90 dark:bg-white/10 shadow-xl dark:shadow-none text-slate-500 dark:text-white/40 cursor-not-allowed border border-white/5" 
          ...
          <AnimatePresence>
            {scanResult === 'success' && pegawaiData && (
              ...
              >
                <div className="bg-emerald-50 dark:bg-emerald-500/10 backdrop-blur-2xl border border-emerald-200 dark:border-emerald-500/30 rounded-3xl p-5 md:p-6 flex items-center gap-5 text-left w-full max-w-md shadow-2xl">
            ...
            {scanResult === 'error' && (
              <motion.div 
                ...
                className="absolute top-6 left-6 right-6 z-30 flex justify-center"
              >
                <div className="bg-red-50 dark:bg-red-500/10 backdrop-blur-2xl border border-red-200 dark:border-red-500/30 rounded-3xl p-5 md:p-6 flex items-center gap-5 text-left w-full max-w-md shadow-2xl">
