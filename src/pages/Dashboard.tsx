 ...
 return (
  <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 h-full p-4 md:p-8 relative text-slate-900 dark:text-white">
   ...
   <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div className="bg-slate-100 dark:bg-slate-800 shadow-sm border border-slate-300 dark:border-slate-700 rounded-3xl p-6 hover:bg-white dark:hover:bg-white dark:hover:bg-white/10 transition-all group">
    ...
    <div className="bg-slate-100 dark:bg-slate-800 shadow-sm border border-slate-300 dark:border-slate-700 rounded-3xl p-6 hover:bg-white dark:hover:bg-white dark:hover:bg-white/10 transition-all group">
     ...
     <p className="text-xs font-medium text-slate-700 dark:text-white/40 mt-8 border-t border-slate-300 dark:border-slate-700 pt-4">Berdasarkan data di database (real-time).</p>
    </div>
    ...
    <div className="bg-gradient-to-br from-green-500/20 to-transparent border border-green-500/30 rounded-3xl p-6 relative overflow-hidden group">
     ...
     <p className="text-xs font-medium text-slate-700 dark:text-white/60 mt-8 relative z-10 border-t border-slate-300 dark:border-slate-700 pt-4">
   ...
   <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-6 mt-6">
    <div className="lg:col-span-2 bg-slate-100 dark:bg-slate-800 shadow-sm border border-slate-300 dark:border-slate-700 rounded-3xl p-6 ">
     <div className="flex justify-between items-center mb-6 border-b border-slate-300 dark:border-slate-700 pb-4">
      ...
      <select className="bg-slate-100 dark:bg-slate-800 shadow-sm border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium px-4 py-2 rounded-full appearance-none cursor-pointer focus:outline-none focus:border-green-500/50">
    ...
    <div className="bg-slate-100 dark:bg-slate-800 shadow-sm border border-slate-300 dark:border-slate-700 rounded-3xl p-6 flex flex-col">
     <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-6 border-b border-slate-300 dark:border-slate-700 pb-4">Rekap Ekspresi</h3>
     <div className="space-y-6 flex-1">
       <div className="space-y-3">
        <div className="flex justify-between text-xs font-medium">
          <div className="flex items-center gap-3 text-slate-700 dark:text-white/80">
           <div className="w-8 h-8 bg-slate-200 dark:bg-slate-700 shadow-sm dark:shadow-none rounded-xl flex items-center justify-center border border-white/10">
        ...
        <div className="w-full bg-slate-200 dark:bg-slate-700 shadow-sm dark:shadow-none h-1.5 rounded-full overflow-hidden">
